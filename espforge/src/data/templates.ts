...
export const projectTemplates: ProjectTemplate[] = [
  ...
  },
  {
    id: 'ir_rf_proxy',
    name: 'IR/RF Proxy',
    description: 'Universal IR proxy for Home Assistant — learn and replay any IR remote without reflashing. Experimental ESPHome feature.',
    icon: 'Wifi',
    recommendedBoards: ['esp32dev', 'd1_mini', 'esp32c3_devkitm', 'seeed_xiao_esp32c3'],
    components: [
      { id: 'ir_1', type: 'ir.transmitter', name: 'IR Transmitter', config: { carrier_duty_percent: 50 }, pins: { pin: null } },
      { id: 'ir_2', type: 'ir.receiver', name: 'IR Receiver', config: { dump: 'all', tolerance: 25 }, pins: { pin: null } },
      { id: 'ir_3', type: 'ir.proxy', name: 'IR/RF Proxy', config: { receiver_frequency: '38kHz' }, pins: {} },
      { id: 'sensor_4', type: 'sensor.wifi_signal', name: 'WiFi Signal', config: { name: 'WiFi Signal', update_interval: '60s' }, pins: {} },
      { id: 'sensor_5', type: 'sensor.uptime', name: 'Uptime', config: { name: 'Uptime' }, pins: {} },
      { id: 'text_sensor_6', type: 'text_sensor.wifi_info', name: 'WiFi Info', config: { ip_address_name: 'IP Address', ssid_name: 'Connected SSID' }, pins: {} },
      { id: 'button_7', type: 'button.restart', name: 'Restart', config: { name: 'Restart' }, pins: {} },
    ...
    automations: [],
    tags: ['ir', 'remote', 'proxy', 'universal'],
  },
  {
    id: 'oled_status',
